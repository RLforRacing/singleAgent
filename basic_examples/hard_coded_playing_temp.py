...
left_curve_speed_soft = [-0.75, 0.0, 0.0]
right_curve_speed_soft = [0.75, 0.0, 0.0]
left_soft_v1 = [-0.5, 0.0, 0.0]
right_soft_v1 = [0.5, 0.0, 0.0]
left_soft_v2 = [-0.25, 0.0, 0.0]
right_soft_v2 = [0.25, 0.0, 0.0]
accelarate = [0.0, 0.8, 0.15]
accelarate_v2 = [0.0, 0.6, 0.15]
brake = [0.0, 0.0, 0.15]
